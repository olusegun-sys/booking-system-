  ...
  const fetchStaff = async () => {
    try {
      const response = await fetch(
        `${API_BASE}/api/businesses/${business.id}/staff`,
        {
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            "Manage your staff and their permissions",
          ),
        ),
      ),
      React.createElement(
        "button",
        { onClick: () => setShowAddForm(true), style: addButtonStyle },
        React.createElement(UserPlus, { size: 18 }),
        " Invite Staff",
      ),
    ),
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              editingStaff ? "Edit Team Member" : "Invite Team Member",
            ),
            React.createElement(
              "button",
              {
            ...
            React.createElement(
              ...
              React.createElement("input", {
                ...
                style: {
                  ...
                  borderRadius: "12px",
                  fontSize: "14px",
                  background: editingStaff ? "#f1f5f9" : "white",
                },
              }),
            ),
            !editingStaff &&
      ...
      ? React.createElement(
          ...
          !searchTerm &&
            ...
            React.createElement(
              ...
              React.createElement(UserPlus, { size: 14 }),
              " Invite Staff",
            ),
        )
      : React.createElement(
          "div",
          { style: staffGridStyle },
          filteredStaff.map((member) => {
            const roleStyle = getRoleStyle(member.role);
            const RoleIcon = roleStyle.icon;
            return React.createElement(
              "div",
              { key: member.id, style: staffCardStyle },
              React.createElement(
                "div",
                { style: staffCardContentStyle },
                React.createElement(
                  "div",
                  { style: staffHeaderStyle },
                  React.createElement(
                    "div",
                    { style: avatarStyle },
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      "div",
                      { style: staffEmailStyle },
                      React.createElement(Mail, { size: 12 }),
                      member.email,
                    ),
                    React.createElement(
                      "div",
                      { style: roleBadgeStyle(roleStyle) },
