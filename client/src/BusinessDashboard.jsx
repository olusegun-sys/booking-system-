...
function BusinessDashboard() {
    ...
    function handleProfileUpdate(event) {
      if (event.detail && event.detail.business) {
        ...
        localStorage.setItem(
          "currentBusiness",
          JSON.stringify(event.detail.business),
        );
      }
    }
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            confirmedBookings + "/" + bookingLimit,
          ),
          React.createElement(
            "div",
            {
          ...
          bookings.slice(0, 5).map((booking) =>
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  "p",
                  { style: { fontWeight: "500", color: "#0f172a", margin: 0 } },
              ...
              React.createElement(
                ...
                React.createElement(
                  "p",
                  { style: { fontWeight: "600", color: "#4f46e5", margin: 0 } },
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        "div",
        { style: { padding: isDesktop ? "32px" : "20px" } },
        renderContent(),
      ),
    ),
  );
