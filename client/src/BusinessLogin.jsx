...
var BusinessLogin = function (props) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        "div",
        { style: { padding: "2rem 2rem 0 2rem", textAlign: "center" } },
        React.createElement(
          "div",
          {
            style: {
      ...
      React.createElement(
          ...
          React.createElement(
            "button",
            {
              ...
              style: {
                ...
                transition: "all 0.2s",
                boxShadow:
                  loginType === "owner" ? "0 1px 3px rgba(0,0,0,0.05)" : "none",
              },
            },
            "Business Owner",
          ),
          React.createElement(
            "button",
            {
              ...
              style: {
                ...
                transition: "all 0.2s",
                boxShadow:
                  loginType === "staff" ? "0 1px 3px rgba(0,0,0,0.05)" : "none",
              },
            },
            "Staff",
          ),
        ...
        React.createElement(
          ...
          loading
            ? "Signing in..."
            : [
                React.createElement(LogIn, { key: "icon", size: 16 }),
                " Login as " + (loginType === "owner" ? "Owner" : "Staff"),
              ],
        ),
