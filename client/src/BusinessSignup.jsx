    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          "Join 200+ Nigerian businesses",
        ),
        React.createElement(
          "p",
          { style: { color: "#64748b", fontSize: "0.875rem" } },
          "Already using Booking Hub to grow their revenue",
        ),
      ),
      ...
      React.createElement(
        "div",
        {
          style: {
            ...
            padding: "2rem",
            boxShadow:
              "0 20px 35px -10px rgba(0,0,0,0.1), 0 1px 3px rgba(0,0,0,0.05)",
          },
        },
        ...
        React.createElement(
          ...
          step === 1
            ? "Set up in 3 minutes. First 50 bookings free."
            : step === 2
              ? "Help guests find you easily."
                ...
                businessTypes.map(function (bt) {
                  ...
                  return React.createElement(
                    "div",
                    {
                      key: bt.id,
                      onClick: function () {
                        updateField("businessType", bt.id);
                      },
                      style: {
                        padding: "0.75rem",
                        background: isSelected ? bt.bg : "white",
                        border:
                          "1.5px solid " + (isSelected ? bt.color : "#e2e8f0"),
                        borderRadius: "12px",
                        cursor: "pointer",
                        textAlign: "center",
                      },
                            ...
                            style: {
                              ...
                              background:
                                formData.state === s
                                  ...
                                  : "transparent",
                              color:
                                formData.state === s ? "#4f46e5" : "#334155",
                            },
                          },
                          s,
                        );
        ...
        React.createElement(
          ...
          step < 3
            ...
            : React.createElement(
                ...
                loading
                  ? React.createElement(Loader, { size: 16 })
                  : React.createElement(CheckCircle, { size: 16 }),
