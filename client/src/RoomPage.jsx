...
function RoomPage({ business, onBack }) {
  ...
  const fetchRooms = async () => {
    try {
      ...
      const response = await fetch(
        `${API_BASE}/api/businesses/${business.id}/rooms`,
        {
          headers: {
  ...
  const handleDeleteRoom = async (room) => {
    ...
    try {
      const response = await fetch(
        `${API_BASE}/api/businesses/${business.id}/rooms/${room.id}`,
        {
          method: "DELETE",
          headers: {
            Authorization: "Bearer " + token,
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "button",
          { onClick: onBack, style: styles.backButton },
          React.createElement(ArrowLeft, { size: 16 }),
          " Back to Dashboard",
        ),
        React.createElement(
          "h2",
          { style: { ...styles.title, marginTop: "16px" } },
      ...
      React.createElement(
        "button",
        { onClick: () => handleOpenModal(), style: styles.addButton },
    ...
    rooms.length === 0
      ...
      : React.createElement(
          "div",
          { style: styles.roomsGrid },
          rooms.map((room) =>
            React.createElement(
              "div",
              { key: room.id, style: styles.roomCard },
              React.createElement(
                "div",
                ...
                room.amenities &&
                  ...
                  React.createElement(
                    ...
                    room.amenities.map((amenity) =>
                      React.createElement(
                        "span",
                        { key: amenity, style: styles.amenityTag },
                        amenity,
                      ),
                    ),
                  ),
    ...
    showModal &&
      React.createElement(
        "div",
        { style: styles.modalOverlay, onClick: handleCloseModal },
        React.createElement(
          "div",
          ...
          React.createElement(
            ...
            React.createElement(
              "button",
              { onClick: handleCloseModal, style: styles.closeBtn },
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  "button",
                  { onClick: handleAddAmenity, style: styles.amenityAddBtn },
                  React.createElement(Plus, { size: 18 }),
                ),
              ),
              React.createElement(
                "div",
                { style: styles.existingAmenities },
                formData.amenities.map((amenity) =>
                  React.createElement(
                    "span",
                    { key: amenity, style: styles.existingAmenityTag },
                    amenity,
                    React.createElement(
                      "button",
                      {
          ...
          React.createElement(
            ...
            React.createElement(
              "button",
              { onClick: handleCloseModal, style: styles.cancelBtn },
              "Cancel",
            ),
            React.createElement(
              "button",
